...
{
public:
	// hack to get the GeometryGenerator to use the Igra Vertex
	typedef igra::Vertex  Vertex;
	...
	///</summary>
	void CreateSphere(float radius, unsigned sliceCount, UINT stackCount, MeshData& meshData);
...
private:
	void ReverseWinding(MeshData& meshData);
