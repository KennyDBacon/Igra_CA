...
// missing function from "MathHelper.h"
...
void GeometryGenerator::ReverseWinding(MeshData& meshData)
{
	// foreach set of 3 indexes: swap index 1 & 2
	for(unsigned i=0;i<meshData.Indices.size();i+=3)
	{
